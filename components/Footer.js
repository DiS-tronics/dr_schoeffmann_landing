...
export default function Footer() {
  return (
    <footer className="bg-footer-brown text-gray-300">
      <div className="max-w-6xl mx-auto px-4 py-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm mt-2 font-semibold text-gray-300">Ordinationszeiten: Ausschließlich nach<br />vorheriger Terminvereinbarung</p>
        </div>
        <div>
      ...
      <div className="border-t border-gray-600 px-4 py-4 text-center text-sm text-gray-300">
        © {new Date().getFullYear()} Dr. Thomas Schöffmann · <Link href="/contact#impressum" className="hover:text-gray-300">Impressum</Link> · <a href="/Datenschutz.pdf" className="hover:text-gray-300">Datenschutz</a>
      </div>
    </footer>
  )
}
