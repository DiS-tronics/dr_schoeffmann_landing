    ...
    <footer className="bg-footer-brown text-gray-300">
      <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm mt-2 text-gray-300">Ausschließlich nach<br />vorheriger Terminvereinbarung</p>
        </div>
        <div>
      ...
      <div className="border-t border-gray-600 px-4 py-4 text-center text-xs text-gray-300">
